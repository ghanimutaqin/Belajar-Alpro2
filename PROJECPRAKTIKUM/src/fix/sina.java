...
public class sina extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(216, 1368, Short.MAX_VALUE))))
        );
...
if (t1.getText().equalsIgnoreCase("")) {
            ...
            try {
                ...
                cn.createStatement().executeUpdate("insert into sina values" + "('" + t1.getText() + "','" + t2.getText() + "','" + t3.getText() + "','" + labelMabna.getText() + "','" + t5.getText() + "','" + t6.getText() + "','" + t7.getText() + "','" + t8.getText() + "')");
                tampilkan();
                reset();
                JOptionPane.showMessageDialog(null, "Berhasil ditambahkan!");

            } catch (SQLException ex) {
                Logger.getLogger(sina.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void buttongantiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttongantiActionPerformed
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/alpro", "root", "");
            cn.createStatement().executeUpdate("update sina set NAMA='" + t2.getText() + "',JURUSAN='" + t3.getText() + "',KAMAR='" + t5.getText() + "',HARI_TASHIH='" + t6.getText() + "',JAM_KOSONG='" + t7.getText() + "',TOTAL_TASHIH='" + t8.getText() + "' where NIM='" + t1.getText() + "'");
            tampilkan();
            reset();
 JOptionPane.showMessageDialog(null, "Data berhasil Diganti!");
    ...
    private void buttonhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonhapusActionPerformed
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/alpro", "root", "");
            cn.createStatement().executeUpdate("delete from sina where NIM='" + t1.getText() + "'");
            tampilkan();
            reset();
    ...
    private void buttoncariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttoncariActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/alpro", "root", "");
            ResultSet rs = cn.createStatement().executeQuery("select * from sina where NAMA like'%" + cari.getText() + "%'or KAMAR like'%" + cari.getText() + "%'or NIM like'%" + cari.getText() + "%'or HARI_TASHIH like'%" + cari.getText() + "%'");
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void tampilkan() {
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/alpro", "root", "");
            ResultSet rs = cn.createStatement().executeQuery("select * from sina ");
            while (rs.next()) {
                String data[] = {rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8)};
                model.addRow(data);
            }
